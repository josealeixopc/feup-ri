...
def render():
    ...
    render_episodes = 3 #Show Z episodes every rendering.
...
if __name__ == '__main__':
    ...
    # plotter = LivePlot(outdir)                              # This is not working even if I import liveplot.py
    ...
    for x in range(total_episodes):
        ...
        print("Starting Episode: "+str(x+1))
